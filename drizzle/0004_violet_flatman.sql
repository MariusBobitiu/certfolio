...
CREATE INDEX "user_recovery_codes_batch_id_idx" ON "user_recovery_codes" USING btree ("batch_id");--> statement-breakpoint
CREATE INDEX "user_recovery_codes_used_at_idx" ON "user_recovery_codes" USING btree ("used_at");