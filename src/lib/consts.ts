...
export const SIGN_IN_IP_RATE_LIMIT_MAX_ATTEMPTS = 20
export const SIGN_IN_ACCOUNT_RATE_LIMIT_MAX_ATTEMPTS = 10
export const SIGN_IN_RATE_LIMIT_WINDOW_MS = 1000 * 60 * 15
export const MFA_IP_RATE_LIMIT_MAX_ATTEMPTS = 20
export const MFA_ACCOUNT_RATE_LIMIT_MAX_ATTEMPTS = 10
export const MFA_RATE_LIMIT_WINDOW_MS = 1000 * 60 * 15
