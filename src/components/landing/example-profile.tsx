        ...
        <div className="overflow-hidden rounded-4xl border border-border bg-card shadow-sm">
          <div className="space-y-8 p-6 sm:p-8 lg:p-10">
            ...
            <section className="relative overflow-hidden rounded-4xl border border-border bg-card p-5 sm:p-7">
              <div className="absolute right-0 bottom-0 h-32 w-32 rounded-full bg-primary/8 blur-3xl" />
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-5">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="space-y-1.5">
                      <h3 className="text-4xl font-semibold tracking-[-0.06em] text-foreground sm:text-5xl">
                        {elena.name}
                      </h3>
                    ...
                    <p className="text-sm font-medium text-muted-foreground">
                      {verifiedCount} independently verified credentials ·{" "}
                      {elenaProjects.length} projects
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-semibold tracking-[-0.02em] text-muted-foreground uppercase">
                Links
              </h4>
            ...
            <div className="space-y-3">
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-muted-foreground">
                  {elenaProjects.length} published projects · {evidenceCount}{" "}
                  evidence links
                </p>
              </div>
