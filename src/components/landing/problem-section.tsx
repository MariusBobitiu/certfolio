...
export function ProblemSection() {
  return (
    <section id="product" className="bg-linear-to-b from-background to-secondary via-background px-5 py-20 sm:px-6 sm:py-28 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-muted-foreground">
            Certifications, code, experience and project context each live in separate places.
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {fragments.map(({ icon: Icon, label, sub }) => (
              <div key={label} className="group flex flex-col items-center gap-2 rounded-2xl border border-border/70 bg-card p-4 text-center transition-colors hover:border-border">
          ...
          <div className="mb-8 flex items-center justify-center">
            <svg className="h-12 w-full max-w-md" viewBox="0 0 400 48" fill="none">
              {/* Left two converge */}
              <path d="M80 0 C80 24, 180 24, 200 48" stroke="currentColor" strokeWidth="1" className="text-border/50" />
              <path d="M160 0 C160 24, 180 24, 200 48" stroke="currentColor" strokeWidth="1" className="text-border/50" />
              {/* Right two converge */}
              <path d="M240 0 C240 24, 220 24, 200 48" stroke="currentColor" strokeWidth="1" className="text-border/50" />
              <path d="M320 0 C320 24, 220 24, 200 48" stroke="currentColor" strokeWidth="1" className="text-border/50" />
              {/* Center dot */}
          ...
          <div className="overflow-hidden rounded-4xl border-2 border-primary/20 bg-card shadow-md">
            ...
            <div className="flex flex-col items-center gap-4 p-6 sm:flex-row sm:justify-between sm:px-8 sm:py-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-base font-semibold text-foreground">{elena.name}</p>
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-muted-foreground sm:gap-5">
                <span className="flex items-center gap-1">
                  ...
                  <span className="font-medium text-emerald-600 dark:text-emerald-300">2 verified</span>
                </span>
            ...
            <div className="border-t border-border/70 bg-secondary/30 px-6 py-3 text-center">
              <p className="text-sm text-muted-foreground">
                One Certfolio profile — identity, credentials, projects and evidence in one place
              </p>
            </div>
          </div>
        </div>
